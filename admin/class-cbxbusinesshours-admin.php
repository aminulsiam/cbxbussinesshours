...
class CbxBusinessHours_Admin {
	...
	public function enqueue_scripts() {
		...
		if ( $page == 'cbxbusinesshours' ) {
			...
			wp_register_script( 'cbxbusinesshours-admin', plugin_dir_url( __FILE__ ) . '../assets/js/cbxbusinesshours-admin.js', array(
				'jquery',
				'jquery-timepicker'
			), time(), true );
			...
			$hoursformat = isset($hoursformats['hoursformat']) ? intval($hoursformats['hoursformat']) : 24;
	...
	public function admin_menu() {
		add_options_page( esc_html__( 'Office Opening & Business Hours', 'cbxbusinesshours' ), esc_html__( 'Office Business Hours', 'cbxbusinesshours' ), 'manage_options', 'cbxbusinesshours', array(
			$this,
			'CBXBusinessHours_options_page_data'
		) );
