...
<div id="postbox-container-1" class="postbox-container">
	<div class="meta-box-sortables">
		...
		<div class="postbox">
			<h3><?php esc_html_e( 'Help & Supports', 'cbxbusinesshours' ); ?></h3>
			<div class="inside">
		...
		<div class="postbox">
			<h3><?php esc_html_e( 'Codeboxr Updates', 'cbxbusinesshours' ); ?></h3>
			<div class="inside">
				<?php
		...
		<div class="postbox">
			<h3><?php esc_html_e( 'Other Wordpress Plugins', 'cbxbusinesshours' ); ?></h3>
			<div class="inside">
				<?php
					include_once( ABSPATH . WPINC . '/feed.php' );
					if ( function_exists( 'fetch_feed' ) ) {
		...
		<div class="postbox">
			<h3><?php esc_html_e( 'Codeboxr on facebook', 'cbxbusinesshours' ) ?></h3>
			<div class="inside">
				<iframe
