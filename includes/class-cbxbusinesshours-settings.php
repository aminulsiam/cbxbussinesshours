		...
		class CBXBusinessHoursSettings
		{
			...
			function callback_weekdays( $args ) {
				...
				foreach ( $dow as $key => $days ) {
					...
					$html .= '&nbsp;&nbsp;<a class="button weekdays_day_resetday "><span class="dashicons dashicons-image-rotate" style="margin-top: 3px;color: blue;"></span>' . esc_html__( 'Reset Day', 'cbxbusinesshours' ).'</a>';
					$html .= ' <a class="button weekdays_day_copytoall "><span class="dashicons dashicons-rest-api" style="margin-top: 3px;color: green;"></span>' . esc_html__( 'Copy to All', 'cbxbusinesshours' ).'</a>';
				...
				$html .= '<p style="text-align: left; padding-left: 120px;"><a class="button weekdays_day_resetall "><span class="dashicons dashicons-image-rotate" style="margin-top: 3px;color: blue;"></span>' . esc_html__( 'Reset(Empty) All Days', 'cbxbusinesshours' ).'</a></p>';
			...
			function show_forms()
			{
				...
				<div class="metabox-holder">
					<?php foreach ($this->settings_sections as $form) { ?>
						<div id="<?php echo $form['id']; ?>" class="cbxbusinesshours_group" style="display: none;">
